(function($) {
    var jqCarouselEvo = function(element, options) {
    ...
    $.fn.jsCarousel = function(options) {
        ...
        for (var i = 0; i < this.length; i++) {
            if (!this[i].carousel) {
                this[i].carousel = new jqCarouselEvo(this[i],options);
    ...
    $.fn.carousel.defaults = {
        ...
        slidesPerScroll: 5,
        speed: 500, //ms
        buttonNav: 'none', //colud be numbers or bullet
        directionNav: false,
        autoplay: true,
        ...
        description: false,
        descriptionContainer: '.jq-description',
        backOpacity: 1,
